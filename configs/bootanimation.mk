...
# PA XHDPI Devices
ifneq ($(filter pa_nozomi pa_falcon pa_tomato pa_armani pa_evita pa_xt926 moto_msm8960_jbbl pa_hercules pa_i9300 pa_skyrocket pa_titan pa_togari,$(TARGET_PRODUCT)),)
    PRODUCT_COPY_FILES += \
        vendor/pa/prebuilt/bootanimation/1280x720.zip:system/media/bootanimation.zip
endif

# PA HDPI Devices
ifneq ($(filter pa_condor pa_p3100 pa_nicki pa_p3110 pa_taoshan,$(TARGET_PRODUCT)),)
    PRODUCT_COPY_FILES += \
